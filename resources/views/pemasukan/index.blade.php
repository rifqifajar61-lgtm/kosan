...
<div class="page-header">
    ...
    <a href="{{ route('pemasukan.tambah') }}" class="btn-add">
...
<div class="table-card">
    <div class="table-card-header">
        <div>
            ...
            <div class="table-card-sub">Riwayat transaksi dengan keterangan bulan yang dibayar</div>
        </div>
    </div>
        ...
        <table class="ktable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="date-text">{{ date('d-m-Y', strtotime($p->tanggal_pemasukan)) }}</span>
                    </td>
                    <td>
                        @if($p->bulan_dibayar && count($p->bulan_dibayar) > 0)
                            <div class="bulan-tags-wrap">
                                @foreach($p->bulan_dibayar as $bulan)
                                    <span class="bulan-tag-sm">
                                        <i class="bi bi-calendar-check" style="font-size:9px"></i>
    ...
    <a href="{{ route('pemasukan.edit', $p->id_pemasukan) }}" class="btn-edit">
