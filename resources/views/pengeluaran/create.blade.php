...
<div class="page-header">
    <div class="ph-left">
        ...
        <div class="ph-title">Tambah Pengeluaran Baru</div>
    </div>
</div>
...
<form action="{{ route('pengeluaran.simpan') }}" method="POST">
    ...
    <div class="form-layout">
        <div class="sc">
            <div class="sc-head">
                <div><div class="sc-title">Detail Pengeluaran</div><div class="sc-desc">Isi data pengeluaran kost</div></div>
            </div>
            <div class="sc-body">
                <div class="fg">
                ...
                <div class="fg">
                    ...
                    <select name="jenis_pengeluaran" id="jenisSelect" class="fc" required>
                        ...
                        <option value="Listrik"    {{ old('jenis_pengeluaran')=='Listrik'    ?'selected':'' }}>Listrik</option>
                        <option value="Air"        {{ old('jenis_pengeluaran')=='Air'        ?'selected':'' }}>Air</option>
                        <option value="Internet"   {{ old('jenis_pengeluaran')=='Internet'   ?'selected':'' }}>Internet</option>
                        <option value="Kebersihan" {{ old('jenis_pengeluaran')=='Kebersihan' ?'selected':'' }}>Kebersihan</option>
                        <option value="Perbaikan"  {{ old('jenis_pengeluaran')=='Perbaikan'  ?'selected':'' }}>Perbaikan</option>
                        <option value="Lainnya"    {{ old('jenis_pengeluaran')=='Lainnya'    ?'selected':'' }}>Lainnya</option>
                    </select>
                </div>
                <div class="fg hidden" id="fieldKeterangan"
                     style="{{ old('jenis_pengeluaran')=='Lainnya' ? 'display:flex' : '' }}">
                    ...
                    <input type="text" name="keterangan" id="inputKeterangan" class="fc"
                           ...
                           {{ old('jenis_pengeluaran')=='Lainnya' ? 'required' : '' }}>
                </div>
                <div class="fg">
        ...
        <div>
            <div class="sb">
                <div class="sb-head">
                    <div class="sb-kicker">Detail</div>
                    <div class="sb-title">Transaksi Pengeluaran</div>
                </div>
                <div class="sb-body">
                    <div class="prev-nominal-box">
                        ...
                        <div class="prev-nominal-sub" id="prevTanggalSub">—</div>
                    </div>
                    <ul class="prev-list">
                        <li class="prev-item">
                            <div class="prev-ico"><i class="bi bi-tag-fill"></i></div>
                            <div><div class="prev-lbl">Jenis</div><div class="prev-val empty" id="prevJenis">—</div></div>
                        </li>
                        <li class="prev-item">
                            <div class="prev-ico"><i class="bi bi-calendar3"></i></div>
                            <div><div class="prev-lbl">Tanggal</div><div class="prev-val empty" id="prevTanggal">—</div></div>
                        </li>
                    </ul>
                </div>
            </div>
...
<script>
    ...
    jenisSelect.addEventListener('change', function() {
        if (this.value === 'Lainnya') {
            ...
            fieldKeterangan.style.animation = 'fadeField .2s ease both';
    ...
    if (inputJumlah.value)  inputJumlah.dispatchEvent(new Event('input'));
